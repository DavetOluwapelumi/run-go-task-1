...
// the constructor function of the object
    constructor(firstName:string, lastName:string, email:string, occupation:string){
...
class Driver extends Person{
    // Telling typescript number will be initialised
    rating!: number;
